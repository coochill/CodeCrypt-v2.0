...
class MineCipherApp:
    def __init__(self):
        ...
        self.difficulty_presets = DIFFICULTY_PRESETS
        self.difficulty_word_length = DIFFICULTY_WORD_LENGTH
        self.selected_difficulty = "Medium"
        self.cipher_names = list(MINECIPHER_CIPHERS.keys())
        self.selected_cipher = self.cipher_names[0]
        self.cipher_examples = {
            name: data.get("example", "") for name, data in MINECIPHER_CIPHERS.items()
        }
